...
def cost_pathfind(input_file, move_cost=1, turn_cost=0, turn_heuristic=False):
    ...
    dist_array = np.tile(np.absolute(x_grid - end_x) + np.absolute(y_grid - end_y), (4, 1, 1)) * turn_cost
