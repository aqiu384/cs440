...
axl.matshow(image_sums[:, :, 3].squeeze())
axl = fig.add_subplot(4, 3, 2)
axl.matshow(image_sums[:, :, 8].squeeze())
axl = fig.add_subplot(4, 3, 3)
axl.matshow((image_sums[:, :, 3] - image_sums[:, :, 8]).squeeze())
axl = fig.add_subplot(4, 3, 4)
axl.matshow(image_sums[:, :, 4].squeeze())
axl = fig.add_subplot(4, 3, 5)
axl.matshow(image_sums[:, :, 9].squeeze())
axl = fig.add_subplot(4, 3, 6)
axl.matshow((image_sums[:, :, 4] - image_sums[:, :, 9]).squeeze())
axl = fig.add_subplot(4, 3, 7)
axl.matshow(image_sums[:, :, 7].squeeze())
axl = fig.add_subplot(4, 3, 8)
axl.matshow(image_sums[:, :, 9].squeeze())
axl = fig.add_subplot(4, 3, 9)
axl.matshow((image_sums[:, :, 7] - image_sums[:, :, 9]).squeeze())
axl = fig.add_subplot(4, 3, 10)
axl.matshow(image_sums[:, :, 8].squeeze())
axl = fig.add_subplot(4, 3, 11)
axl.matshow(image_sums[:, :, 9].squeeze())
axl = fig.add_subplot(4, 3, 12)
axl.matshow((image_sums[:, :, 8] - image_sums[:, :, 9]).squeeze())
plt.show()
